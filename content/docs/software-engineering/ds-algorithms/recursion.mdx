...
For this example, we could've used a simple for-loop to get the same result. Every time we do a loop, we can use recursion instead. This doesn't work the other way around. There aren't things that recursion can do that loops can't
